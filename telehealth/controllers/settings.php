...
<form method="post" class="mt-3">
    ...
    <div id="telesalud_fields">
        <div class="mb-3">
            ...
            <input type="text" name="telesalud_api_url" class="form-control" value="<?php echo attr(th_get('telesalud_api_url','')); ?>" placeholder="https://your-host/api">
        </div>
        <div class="mb-3">
            <label class="form-label">API Token</label>
            <input type="text" name="telesalud_api_token" class="form-control" value="<?php echo attr(th_get('telesalud_api_token','')); ?>">
        </div>
        <div class="mb-3">
